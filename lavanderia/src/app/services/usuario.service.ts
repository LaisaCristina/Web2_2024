...
export class UsuarioService {
  ...
  cadastrarUsuario(usuario: UsuarioCadastro, endereco: Endereco): Observable<UsuarioCadastro> {
    const payload = { usuario, endereco };
    return this.httpClient.post<UsuarioCadastro>(this.BASE_URL + 'cadastrarUsuario', JSON.stringify(payload), this.httpOptions)
      .pipe(
        catchError((e) => {
